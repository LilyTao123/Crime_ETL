...
from crime_rate.common.custom_exceptions import WrongFormatException
from crime_rate.common.constants import S3FileTypes
...
class S3BucketConnector():
    ...
    def __put_object(self, out_buffer: StringIO or BytesIO, key:str):
        ...
        :out_buffer: StringIO | BytesIO that should be writted
        :key: target key of the saved life
        '''
